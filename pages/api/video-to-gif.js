  ...
  return new Promise((resolve, reject) => {
    form.parse(req, async (err, fields, files) => {
      ...
      try {
        ...
        console.log('Processing video to GIF:', filename, 'Size:', file.size);
        ...
        console.log('Forwarding to API:', `${API_BASE_URL}/video-to-gif`);
        
        // Send to external API
        const response = await fetch(`${API_BASE_URL}/video-to-gif`, {
          method: 'POST',
          body: formData,
          headers: {
            ...formData.getHeaders(),
