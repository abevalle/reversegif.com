  ...
  return new Promise((resolve, reject) => {
    form.parse(req, async (err, fields, files) => {
      ...
      try {
        ...
        console.log('Extracting PNG frames from video:', filename, 'Size:', file.size);
        ...
        const apiUrl = needsFiltering ? `${API_BASE_URL}/video-to-png?as_zip=false` : `${API_BASE_URL}/video-to-png`;
