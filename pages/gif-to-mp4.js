...
const GifToMp4DropZone = () => {
  // This wrapper ensures that the DropZone component is used specifically for GIF to MP4 conversion
  return <DropZone gifToMp4Mode={true} />;
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "ReverseGIF.com - GIF to MP4 Converter",
              "applicationCategory": "ImageEditing",
              "applicationSubCategory": "GIF to MP4 Converter",
              "operatingSystem": "Web",
              "offers": {
                "@type": "Offer",
                "price": "0.00",
              ...
              "description": "A free online tool to convert GIF animations to MP4 videos. Process GIFs directly in your browser with no file size limits and complete privacy.",
              "featureList": [
              ...
              "softwareVersion": "1.0",
              "url": "https://reversegif.com/gif-to-mp4"
            })
          }}
        />
        <title>Convert GIF to MP4 Online - Free & Private | ReverseGIF.com</title>
        <meta name="description" content="Transform your GIFs into high-quality MP4 videos with our free online converter. No upload needed - processing happens in your browser for complete privacy." />
      </Head>
      <Header />
      <main className="flex-grow container mx-auto px-4 py-6 md:p-4">
        ...
        <div className="block md:hidden text-center mb-6">
          ...
          <h2 className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-4">
            Transform GIFs into efficient MP4 videos - 100% Free & Private
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-start">
          ...
          <div className="space-y-4 md:space-y-6 order-2 md:order-1">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 md:p-6 shadow-lg">
              <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4">Why Convert GIF to MP4?</h3>
              <div className="prose prose-sm md:prose-base dark:prose-invert">
                <p className="text-gray-600 dark:text-gray-300 mb-3">
                  Convert animated GIFs to MP4 video format for dramatically smaller file sizes and better compatibility. MP4 files are typically 80-90% smaller than equivalent GIFs while maintaining the same visual quality, making them perfect for web use and social media.
                </p>
                <p className="text-gray-600 dark:text-gray-300 mb-3">
                  Modern browsers, mobile devices, and social platforms prefer MP4 over GIF for animated content. MP4 videos load faster, consume less bandwidth, and provide smoother playback across all devices and platforms.
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  Our converter uses H.264 encoding with optimized settings for web delivery, ensuring your animations play perfectly everywhere while keeping file sizes minimal.
                </p>
              </div>
            </div>
